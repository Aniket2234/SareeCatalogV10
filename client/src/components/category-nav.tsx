      ...
      <section className="bg-white" data-testid="category-nav-loading">
        <div className="py-1 sm:py-2">
          <div className="relative">
            <div className="overflow-hidden">
              <div
                className="flex space-x-8 pb-1 sm:pb-2 pt-0 sm:pt-1 px-4 sm:px-6"
                style={{ minHeight: "260px" }}
              >
                {Array.from({ length: 6 }).map((_, index) => (
                  <Skeleton
              ...
              <div
                className="bg-gray-200 rounded-full h-1 mt-1"
                style={{
                  width: "100vw",
              ...
              >
                <div
                  className="bg-gradient-to-r from-[#D4AF37] via-[#FFD700] to-[#D4AF37] h-1 rounded-full shadow-sm"
                  style={{
                    width: 0,
                  }}
                />
      ...
      <div className="py-1 sm:py-2">
        <div className="relative">
          <div
            ...
            onMouseUp={handleMouseUp}
            onMouseMove={handleMouseMove}
            className="flex space-x-6 overflow-x-auto scrollbar-hide pb-1 sm:pb-2 pt-0 sm:pt-1 scroll-smooth items-center select-none px-4 sm:px-6"
            style={{
              scrollbarWidth: "none",
              msOverflowStyle: "none",
              minHeight: "20px",
